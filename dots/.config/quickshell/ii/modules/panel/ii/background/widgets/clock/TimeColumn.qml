...
Column {
    ...
    property bool isEnabled: Appearance.activeMonitorBackground.widgets.clock.cookie.timeIndicators
    property color color: Appearance.colors.colOnSecondaryContainer

    property bool hourMarksEnabled: Appearance.activeMonitorBackground.widgets.clock.cookie.hourMarks
    spacing: -16
