...
Item {
    ...
    property string style: Appearance.activeMonitorBackground.widgets.clock.cookie.dialNumberStyle // "dots", "numbers", "full", "hide"
    property string dateStyle : Appearance.activeMonitorBackground.widgets.clock.cookie.dateStyle
