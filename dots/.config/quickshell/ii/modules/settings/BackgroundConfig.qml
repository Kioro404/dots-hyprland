...
ContentPage {
    ...
    ContentSection {
        ...
        ConfigSwitch {
            id: wallpaperSwitch
            text: Translation.tr("Enable %1").arg(Translation.tr("Wallpaper").toLowerCase())
            checked: !Config.options.background.disabled
            onCheckedChanged: Config.options.background.disabled = !checked;
            StyledToolTip {
                text: Translation.tr("Disable wallpaper background")
            }
        }
    }

    ContentSection {
        visible: !Config.options.background.disabled
